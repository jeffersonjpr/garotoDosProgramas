...
.align 4
	...
	resultado: .asciiz "resultado.ppm"			# Nome do modelo de fundo
...
.text
	...
	la $a0, mLarq						# endereço da string
	syscall
	...
	#imprimindo mensagem de auxilio usuario
	li $v0, 4						# code sc 4 print string
	la $a0, mLqnt						# endereço da string
	syscall
...
abreDescritores:
	...
	blt $v0, $zero, finalizandocomerro			# erro ao abrir o 1º arquivo (nao existe ou nome errado)
	...
	blt $v0, $zero, finalizandocomerro			# caso aconteça erro ao abrir o arquivo
...
removebarran:
	...
	loopremovebn:
		...
		beq $t0, '\0', fimlrbn			# comparaçao para saber se chegou no final da string
