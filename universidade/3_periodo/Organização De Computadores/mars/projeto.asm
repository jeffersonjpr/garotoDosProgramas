...
.align 4
	...
	localArquivo: .space 100				# espaço para nome do arquivo ou caminho ate ele
...
pegatamanho:
	...
	fimlooppt:					# agora t0 tem a posicao da porcentagem no nome do arquivo
		...
		tevecomentario:
			...
			li $v0, 16			# code v0 fechando arquivo
			add $a0, $s0, $zero		# primeiro argumento dda
			syscall
